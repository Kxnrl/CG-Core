 ...
 */
public Native_GetPartnerSlot(Handle:plugin, numParams)
{
	return marriage_slots[GetNativeCell(1)];
}

/**
 * Retrieves the marriage money of a client.
 *
 * @param plugin			Plugin handle.
 * @param numParams			Number of parameters.
 * @return					The marriage money, -1 if the client is not married.
 */
 ...
 * @noreturn
 */
public Native_GetPartnerName(Handle:plugin, numParams)
{
 ...
 * @noreturn
 */
public Native_GetPartnerID(Handle:plugin, numParams)
{
 ...
 */
public Native_GetMarriageScore(Handle:plugin, numParams)
{
 ...
 */
public Native_GetWeddingTime(Handle:plugin, numParams)
{
 ...
 * @noreturn
 */
public Native_GetProposals(Handle:plugin, numParams)
{	
 ...
 * @noreturn
 */
public Native_GetMarriages(Handle:plugin, numParams)
{	
	new array[MAXPLAYERS + 1];
	new maxLen = GetNativeCell(2);
