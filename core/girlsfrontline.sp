...
void GirlsFL_PrepareMenu()
{
    ...
    //HG
    GFL_Menu_Select_Guns.AddItem("cz75a", "CZ75a");
    GFL_Menu_Select_Guns.AddItem("deagle", "DesertEagle");
    GFL_Menu_Select_Guns.AddItem("elite", "DualBerettas");
    ...
    GFL_Menu_Select_Guns.AddItem("revolver", "Revolver");
    GFL_Menu_Select_Guns.AddItem("tec9", "Tec-9");
    GFL_Menu_Select_Guns.AddItem("usp_silencer", "USPSilenced");
    //SMG
    ...
    GFL_Menu_Select_Guns.AddItem("m4a1_silencer", "M4A1Silenced");
    GFL_Menu_Select_Guns.AddItem("sg556", "SG553");
    //MG
    GFL_Menu_Select_Guns.AddItem("m249", "M249Para");
...
void DisplayGFLMainMenu(int client)
{
    ...
    DrawPanelTextEx(panel, "好感: 0" , GFL_Client_Data[client][iTendresse]);
